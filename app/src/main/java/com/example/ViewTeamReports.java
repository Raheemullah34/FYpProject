...
public class ViewTeamReports extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_view_team_reports);
    ...
    public void fetch_team_repots(){
        ...
        if (checkInternatStatus) {
            ...
            volleyService.fetchDuties(AppConstants.domain_url + AppConstants.directory + AppConstants.fetch_team_report,
                    dateDutiesModel, new VolleyService.VolleyResponseListener() {
                        ...
                        public void onSuccess(String response) {
                            ...
                            if (response.matches("false")) {
                                ...
                                Toast.makeText(ViewTeamReports.this, "No data Found", Toast.LENGTH_SHORT).show();
                                ...
                                try {
                                    ...
                                    for (int i = 0; i < data.length(); i++) {
                                        ...
                                        dutiesModel.setDuty_des(jsonObject.getString("duty_des"));
                                    ...
                                    duties_adapter = new Duties_adapter(dutiesModelArrayList,ViewTeamReports.this);
