...
public class MainActivity extends AppCompatActivity {
    ...
    Button btnAdmin,btnWorker,btnParents;
    TextView myaddress;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnWorker.setOnClickListener(new View.OnClickListener() {
         ...
         Intent intent = new Intent(MainActivity.this,Worker_Disk.class);
         startActivity(intent);
        ...
        btnParents.setOnClickListener(new View.OnClickListener() {
          ...
          Intent intent = new Intent(MainActivity.this,Parent_Disk.class);
          startActivity(intent);
...
/*
                            ...
                            btnWorker.setText(String.format(Locale.ENGLISH, "%s: %f",
                                    mLatitudeLabel,
                                    mLastLocation.getLatitude()));
                            btnParents.setText(String.format(Locale.ENGLISH, "%s: %f",
                                    mLongitudeLabel,
                                    mLastLocation.getLongitude()));
*/
                            myaddress.setText(getAdressFromCordinates(mLastLocation.getLatitude(),mLastLocation.getLongitude()));

                        } else {
                            Log.w(AppConstants.TAG, "getLastLocation:exception", task.getException());
    ...
    public String getAdressFromCordinates(double lat,double lang){
        ...
        return "address:"+address+" city:"+city+" state:"+state+" country:"+country+" postalCode:"+postalCode+
                " knownName: "+knownName;
